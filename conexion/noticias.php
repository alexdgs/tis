<?php
  if(!isset($titulo)){
    header('Location: ../index.php');
               ...
               $consulta = "SELECT  nombre_documento, ruta_documento, fecha_documento, documento_jefe, descripsion_documento,consultor_tis
                         ...
                         echo "  <tr>
                                     <td>
                                            <div class=\"caja_aviso\"  id=\"aviso".$numero."\" >
                                                  <div class=\"subtitulo_aviso\"><h4>Por : ".$row["consultor_tis"]." </h4>
