...
include('header.php'); ?>
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="home_grupo.php">Agregar Integrante</a>
					</li>				
				</ul>
			</div>
			<center><h3>Agregar Integrantes a la Grupo Empresa</h3></center>
			<?php if ($numero_integrantes<5) { ?>
			<div class="row-fluid">
				<div class="box span12 ">
					<div class="box-header well">
					<h2><i class="icon-edit"></i> Agregar Integrante a la Grupo Empresa</h2>					
					</div>
					<div class="box-content" id="formulario">
						Usted puede agregar <b><?php echo (5-$numero_integrantes); ?> integrantes m&aacute;s</b>.</br></br>
						<form name="form-data" class="form-horizontal cmxform" method="POST" id="signupForm" accept-charset="utf-8" action="agregar_integrante.php">
							<fieldset>
								...
								<div class="control-group">
								  ...
								  <div class="controls">
									<select name="roles[]" multiple="multiple" data-rel="chosen">
										<?php
			...
			<?php }
				...
				<div class="box span12">
						<div class="box-header well">
							<h2><i class="icon-info-sign"></i> Nota</h2>
						</div>
						<div class="box-content alerts">		
								Usted ha superado el l&iacute;mite m&aacute;ximo de integrantes para una Grupo Empresa.<br>						
						</div>	
					</div><!--/span-->  
				</div><!-- fin row -->
			<?php }
